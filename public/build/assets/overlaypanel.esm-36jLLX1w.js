...
`,I=ae.extend({defaultProps:{__TYPE:"OverlayPanel",id:null,dismissable:!0,showCloseIcon:!1,closeIcon:null,style:null,className:null,appendTo:null,breakpoints:null,ariaCloseLabel:null,transitionOptions:null,onShow:null,onHide:null,children:void 0,closeOnEscape:!0},css:{classes:Re,styles:Le}});function z(n,e){var t=Object.keys(n);if(Object.getOwnPropertySymbols){var r=Object.getOwnPropertySymbols(n);e&&(r=r.filter(function(d){return Object.getOwnPropertyDescriptor(n,d).enumerable})),t.push.apply(t,r)}return t}function Ae(n){for(var e=1;e<arguments.length;e++){var t=arguments[e]!=null?arguments[e]:{};e%2?z(Object(t),!0).forEach(function(r){Pe(n,r,t[r])}):Object.getOwnPropertyDescriptors?Object.defineProperties(n,Object.getOwnPropertyDescriptors(t)):z(Object(t)).forEach(function(r){Object.defineProperty(n,r,Object.getOwnPropertyDescriptor(t,r))})}return n}var _e=l.forwardRef(function(n,e){var t=l.useContext(le),r=I.getProps(n,t),d=l.useState(!1),v=U(d,2),s=v[0],m=v[1],f=I.setMetaData({props:r,state:{visible:s}}),p=f.ptm,i=f.cx;f.sx;var w=f.isUnstyled;ie(I.css.styles,w,{name:"overlaypanel"});var P=l.useRef(""),a=l.useRef(null),y=l.useRef(null),E=l.useRef(!1),O=l.useRef(null),h=l.useRef(null),K=ce({target:y,overlay:a,listener:function(o,c){var b=c.type,S=c.valid;if(S)switch(b){case"outside":r.dismissable&&!E.current&&x();break;case"resize":case"scroll":case"orientationchange":j();break}E.current=!1},when:s}),B=U(K,2),M=B[0],Z=B[1];je(h,r.closeOnEscape,function(){x()});var Y=function(o){return a&&a.current&&!(a.current.isSameNode(o)||a.current.contains(o))},q=function(o,c){return y.current!=null&&y.current!==(c||o.currentTarget||o.target)},G=function(o){x(),o.preventDefault()},J=function(o){E.current=!0,R.emit("overlay-click",{originalEvent:o,target:y.current})},H=function(){E.current=!0},V=function(o,c){s?(x(),q(o,c)&&(y.current=c||o.currentTarget||o.target,setTimeout(function(){A(o,y.current)},200))):A(o,c)},A=function(o,c){y.current=c||o.currentTarget||o.target,s?j():(m(!0),h.current=function(b){!Y(b.target)&&(E.current=!0)},R.on("overlay-click",h.current))},x=function(){m(!1),R.off("overlay-click",h.current),h.current=null},W=function(){a.current.setAttribute(P.current,""),D.set("overlay",a.current,t&&t.autoZIndex||k.autoZIndex,t&&t.zIndex.overlay||k.zIndex.overlay),g.addStyles(a.current,{position:"absolute",top:"0",left:"0"}),j()},X=function(){M(),r.onShow&&r.onShow()},F=function(){Z()},Q=function(){D.clear(a.current),r.onHide&&r.onHide()},j=function(){if(y.current&&a.current){g.absolutePosition(a.current,y.current);var o=g.getOffset(a.current),c=g.getOffset(y.current),b=0;o.left<c.left&&(b=c.left-o.left),a.current.style.setProperty("--overlayArrowLeft","".concat(b,"px")),o.top<c.top?(a.current.setAttribute("data-p-overlaypanel-flipped","true"),w&&g.addClass(a.current,"p-overlaypanel-flipped")):(a.current.setAttribute("data-p-overlaypanel-flipped","false"),w&&g.removeClass(a.current,"p-overlaypanel-flipped"))}},ee=function(){if(!O.current){O.current=g.createInlineStyle(t&&t.nonce||k.nonce);var o="";for(var c in r.breakpoints)o+=`
