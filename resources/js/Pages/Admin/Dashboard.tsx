                ...
                <div className="grid">
                    ...
                    <div className="col-12 xl:col-6">
                        <div className="card h-full">
                            <div className="flex justify-content-between align-items-center mb-3">
                                ...
                                <Dropdown options={overviewWeeks} value={selectedOverviewWeek} onChange={changeOverviewWeek}
                        ...
                        <div className="card h-full">
                            ...
                            <ul className="list-none p-0 m-0">
                                <li className="mb-4 flex align-items-center">
                                    <Avatar label="BS" size="large" shape="circle" className="text-base font-bold" style={{
                                ...
                                <li className="mb-4 flex align-items-center">
                                    <Avatar label="LA" size="large" shape="circle" className="text-base font-bold" style={{
                                    ...
                                    <div className="ml-3">
                                        ...
                                        <span
                                            className="text-color-secondary block">Customer Success at General Electric</span>
                                    </div>
                                </li>
                                <li className="mb-4 flex align-items-center">
                                    <Avatar label="JB" size="large" shape="circle" className="text-base font-bold" style={{
                                ...
                                <li className="mb-4 flex align-items-center">
                                    <Avatar label="JJ" size="large" shape="circle" className="text-base font-bold" style={{
                                ...
                                <li className="mb-4 flex align-items-center">
                                    <Avatar label="AB" size="large" shape="circle" className="text-base font-bold" style={{
                                ...
                                <li className="mb-4 flex align-items-center">
                                    <Avatar label="AF" size="large" shape="circle" className="text-base font-bold" style={{
                                        backgroundColor: 'rgba(250, 219, 95, 0.1)',
                                        color: '#DE911D',
                                        border: '1px solid #FADB5F'
                                    }}></Avatar>
                            ...
                            <Button type="button" className="w-full mt-3" label="View All" icon="pi pi-arrow-right"
                    ...
                    <div className="col-12 lg:col-6 xl:col-3">
                        <div className="card">
                            ...
                            <ul className="list-none p-0 m-0">
                                ...
                                <li className="mb-4 flex align-items-center justify-content-start">
                                    <Avatar icon="pi pi-send" size="large" shape="circle" className="text-base font-bold"
                                            style={{
                                                backgroundColor: 'rgba(250, 219, 95, 0.1)',
                                                color: '#DE911D',
                                                border: '1px solid #FADB5F'
                                ...
                                <li className="mb-4 flex align-items-center justify-content-start">
                                    <Avatar icon="pi pi-video" size="large" shape="circle" className="text-base font-bold"
                                            style={{
                                                backgroundColor: 'rgba(250, 219, 95, 0.1)',
                                                color: '#DE911D',
                                                border: '1px solid #FADB5F'
                    ...
                    <div className="col-12 lg:col-6 xl:col-4">
                        <div className="card h-full">
                            ...
                            <div
                                className="flex align-items-center justify-content-between pb-2 mb-1 border-bottom-1 surface-border">
                                    ...
                                    <table className="w-full">
                                        ...
                                        <tr>
                                            ...
                                            <td className="text-right">
                                                <div
                                                    className="inline-flex align-items-center justify-content-between px-2 py-1 bg-green-100 text-green-900 border-round"
                                            ...
                                            <td className="text-right">
                                                <div
                                                    className="inline-flex p-1 align-items-center justify-content-center surface-100 text-700 p-1 border-round text-sm"
                                                    style={{minWidth: '4rem'}}>
                                        ...
                                        <tr>
                                            ...
                                            <td className="text-right">
                                                <div
                                                    className="inline-flex p-1 align-items-center justify-content-center surface-700 text-100 p-1 border-round text-sm"
                                                    style={{minWidth: '4rem'}}>
                                        ...
                                        <tr>
                                            ...
                                            <td className="text-right">
                                                <div
                                                    className="inline-flex align-items-center justify-content-between px-2 py-1 bg-red-100 text-red-900 border-round"
                                                    style={{minWidth: '3.5rem'}}>
                    ...
                    <div className="col-12 lg:col-6 xl:col-4">
                        <div className="card h-full">
                            ...
                            <p className="line-height-3 mt-0 mb-5">Sit amet nulla facilisi morbi tempus iaculis. Dolor magna
                                eget est lorem ipsum dolor sit. Turpis egestas pretium aenean pharetra magna ac placerat
                                vestibulum lectus.</p>

                            <div className="flex flex-wrap align-items-center justify-content-between">
                                <div className="flex align-items-center">
                                    <Button type="button" icon="pi pi-angle-left" outlined rounded
                                            className="p-button-plain p-button-sm mr-2 p-2 w-2rem h-2rem"></Button>
                                    <Button type="button" icon="pi pi-angle-right" outlined rounded
                                            className="p-button-plain p-button-sm p-2 w-2rem h-2rem"></Button>
                        ...
                        <div className="card widget-timeline">
                            ...
                            <ul className="list-none p-0 m-0">
                                <li className="flex mb-3">
                                    ...
                                    <span
                                        className="flex align-items-center justify-content-center border-circle p-2 timeline-icon bg-blue-100 text-blue-500">
                                    ...
                                    <div className="ml-3 flex-1">
                                        ...
                                        <div className="p-3 border-round" style={{backgroundColor: dynamicBackground()}}>
                                            <div className="flex align-items-center justify-content-between mb-2">
                                                <img src="/demo/images/avatar/xuxuefeng.png" alt="avatar"
                                                     className="w-2rem"/>
                                                <AvatarGroup>
                                                    <Avatar image="/demo/images/avatar/amyelsner.png"
                                                            shape="circle"></Avatar>
                                                    <Avatar image="/demo/images/avatar/asiyajavayant.png"
                                                            shape="circle"></Avatar>
                                                    <Avatar image="/demo/images/avatar/onyamalimba.png"
                                                            shape="circle"></Avatar>
                                                </AvatarGroup>
                                            </div>
                                            <div className="font-bold mb-2">Jeff Atwood</div>
                                            <p className="text-color-secondary text-sm line-height-3 mb-3"
                                               style={{maxWidth: '28rem'}}>
                                                Hooray! I suck at hardware but I was able to get the pi zero W, plus usb
                                                case, plus two color e-ink hat, to work!
                                            </p>

                                            <ProgressBar value={50} showValue={false} className="w-full md:w-6"
                                ...
                                <li className="flex mb-3">
                                    <div className="flex flex-column align-items-center">
                                    <span
                                        className="flex align-items-center justify-content-center border-circle p-2 timeline-icon bg-yellow-100 text-yellow-500">
                                ...
                                <li className="flex mb-3">
                                    <div className="flex flex-column align-items-center">
                                    <span
                                        className="flex align-items-center justify-content-center border-circle p-2 timeline-icon bg-green-100 text-green-500">
                                    ...
                                    <div className="ml-3 flex-1">
                                        ...
                                        <ul className="list-none p-0 m-0">
                                            <li className="flex align-items-center justify-content-start mb-2">
                                                <img src="/demo/images/dashboard/bg-detail.svg" alt="bg"
                                                     className="w-2rem"/>
                    ...
                    <div className="col-12 xl:col-6">
                        <div className="card">
                            ...
                            <Chart type="line" height="328" data={revenueChartData}
                                   options={revenueChartOptions as ChartOptions} id="nasdaq-chart"></Chart>
                        </div>
                    </div>
                </div>
            </MainLayout>
