...
const CreateCustomerPage = ({
                                auth, csrfToken, page = true, onComplete = () => {
    }
                            }: {
    auth?: any,
    csrfToken?: string,
    ...
    const FormElement = () => {
        ...
        return <form onSubmit={handleSubmit} className="grid formgrid p-fluid">
    ...
    return page ? <PageContainer auth={auth} csrfToken={csrfToken}>
        <MainLayout>
            <Head title="Yeni Müşteri Ekle"/>
            <Toast ref={toast}/>
            <div className="card">
    ...
    </PageContainer> : <FormElement key={2}/>;
}
