...
import {getLocations, getOrder} from "@/helpers/Courier/orders";
...
const OrderShowPage = ({
            ...
            <div
                ...
                <div className={`${!page && 'bg-primary-50 py-2 px-3'}`}>
                    ...
                    <div className={"grid row-gap-2"}>
                        ...
                        <div className="col-12">
                            <span className={"text-xl font-semibold"}>İşletme Bilgileri</span>
                        </div>
                        <div className="lg:col-3 md:col-4 col-6 cursor-pointer"
                             data-pr-tooltip={"İşletme Adı"}>
                            <Avatar
                                icon={"pi pi-user"}
                                shape={"circle"}
                                className={"bg-primary-300 font-semibold text-primary-800"}
                        ...
                        <div className="lg:col-3 md:col-4 col-6 cursor-pointer"
                             data-pr-tooltip={"İşletme Telefon Numarası"}>
                            <Avatar
                                icon={"pi pi-phone"}
                                shape={"circle"}
                                className={"bg-primary-300 font-semibold text-primary-800"}
                            />
                            <a className={"font-semibold ml-2 text-color text-decoration-none"}
                               href={`tel:${orderData.business?.phone}`}>{orderData.business?.phone}</a>
                        </div>
                        <div className="lg:col-6 md:col-6 col-12 cursor-pointer" data-pr-tooltip={"İşletme Adresi"}>
                            <Avatar
                                icon={"pi pi-home"}
                                shape={"circle"}
                                className={"bg-primary-300 font-semibold text-primary-800"}
                            ...
                            <span
                                data-pr-position={"bottom"}
                                className={"font-semibold ml-2"}>{orderData.business?.details?.address}</span>
                        </div>
                    </div>
    ...
    return <>
        <Toast ref={toast}/>
        {page ? <PageContainer auth={auth} csrfToken={csrfToken} courierIsTransporting={courierIsTransporting}>
                <MainLayout>
                    <div className="card">
                        <PageComponent/>
                    </div>
